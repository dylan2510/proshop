...
import {productListReducer, productDetailsReducer,
    ...
    productUpdateReducer, productReviewCreateReducer, productTopRateReducer} from './reducers/productReducers';
...
import {orderCeateReducer, orderDetailsReducer, 
...
// set default state of cart from localStorage
const cartItemsFromStorage = localStorage.getItem('carItems') ? 
    JSON.parse(localStorage.getItem('carItems')) : [];

// set default state of user from localStorage
const userInfoFromStorage = localStorage.getItem('userInfo') ? 
    JSON.parse(localStorage.getItem('userInfo')) : null;

// set default state of shipping adddress from localStorage
